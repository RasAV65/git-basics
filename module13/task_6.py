...
if num(n) < 3:
  ...
  print('Изменённое первое число:', calc(n))
  print()
  k = int(input('Введите второе число: '))
  if num(k) < 4:
    print('Введите четырёхзначное число.')
  else:
    print('Изменённое второе число:', calc(k))
    print()
    summ = int(calc(n)) + int(calc(k))
    print('Сумма чисел:', summ)


print()
# этот код изменяет неправильно 4-х значные числа (в каждом числе первая и последняя цифра меняются местами) здесь вторым числом 0.
