...
num = math.ceil(size / speed)
a = math.ceil(100 / (size / speed))
b = 0
c = 0
print()
for i in range (1, num):
  b += speed
  c += a
  print('Прошло', i, 'сек. Скачано', int(b), 'из', int(size), 'Мб', '(' +str(c) +str('%)'))
print('Прошло', i+1, 'сек. Скачано', int(size), 'из', int(size), 'Мб', '(100%)')
